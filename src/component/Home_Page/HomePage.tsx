        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg mb-6 text-justify">
              At Mabsol Hotel, we believe hospitality should be seamless, modern, and customer-friendly. 
              That’s why we developed a Hotel Management System that brings every aspect of your stay into one smart digital platform. 
              From room reservations to restaurant management, our system provides efficiency for hotel staff and convenience for guests.
            </p>
    ...
    Easily book luxurious rooms with modern amenities, designed for your comfort and relaxation.
      ...
      <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-2xl hover:shadow-green-500/70 transition-transform transform hover:-translate-y-2 duration-300">
        <img
          ...
          className="rounded-lg mb-6 h-40 w-full object-cover"
        />
        <h3 className="text-xl font-semibold mb-3">Event & Banquet Hall Booking</h3>
        <p className="text-gray-600">
          Relax and rejuvenate with our premium spa treatments and wellness services designed just for you.
        </p>
      </div>
      ...
      <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-2xl hover:shadow-orange-500/70 transition-transform transform hover:-translate-y-2 duration-300">
        ...
        <p className="text-gray-600">
         Personalized guest assistance for ticket booking, travel guides, and exclusive local experiences — making your stay effortless.
        </p>
      </div>
  ...
  <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
    ...
    <div>
      ...
      <p className="mb-6 text-lg">
        Have questions or want to celebrate your birthday with us?  
        Get in touch and our team will assist you right away!
      </p>

      <div className="space-y-4">
        <p><span className="font-semibold">📍 Address:</span> Mabsol Hotel, Main Street, City Center</p>
        <p><span className="font-semibold">📞 Phone:</span> +91 98765 43210</p>
        <p><span className="font-semibold">📧 Email:</span> contact@mabsolhotel.com</p>
      </div>
    </div>
...
<footer className="bg-gray-900 text-gray-300 py-10 px-6 md:px-20">
  <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
    ...
    <div>
      ...
      <p className="text-sm">
        Experience luxury, comfort, and seamless digital services at Mabsol Hotel.  
        Your perfect getaway for relaxation, dining, and business stays.
      </p>
    </div>
